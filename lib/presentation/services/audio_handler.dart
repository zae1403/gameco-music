...
import '../../injector.dart';
 ...
 AudioPlayerHandler audioHandler = sl<AudioPlayerHandler>();

Future<AudioPlayerHandler> initAudioService() async {
  return await AudioService.init(
    builder: () => AudioPlayerHandlerImpl(),
    config: const AudioServiceConfig(
      androidNotificationChannelId: 'com.zaelani.gamecomusic',
      androidNotificationChannelName: 'Gameco Music',
...
class AudioPlayerHandlerImpl extends BaseAudioHandler
  ...
  void listenForDurationChanges() {
    _player.durationStream.listen((duration) {
      ...
      if (index != null && duration != null && duration != Duration.zero) {
  ...
  Future<List<MediaItem>> getChildren(String parentMediaId,
    ...
    switch (parentMediaId) {
      ...
      default:
        ...
        return _playlist.children.map((source) {
          final mediaItem = _mediaItemExpando[source]!;
          return mediaItem.copyWith(
            displayTitle: mediaItem.title,
            displaySubtitle: mediaItem.album,
